...
latex_documents = [
    (master_doc, 'django-oidc-provider.tex', 'django-oidc-provider Documentation',
     'Juan Ignacio Fiorentino', 'manual'),
]
...
man_pages = [
    (master_doc, 'django-oidc-provider', 'django-oidc-provider Documentation',
     [author], 1)
]
